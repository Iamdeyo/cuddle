            ...
            <div className="flex min-h-[418px] lg:min-h-[600px] items-center">
              <div className="flex mx-auto flex-col items-center text-center gap-1.5 text-white max-w-[50ch] lg:max-w-[632px]">
                ...
                <p className="text-sm lg:text-xl">
                  Our fractional ownership platform allows you to pool with
                  others in order to buy a small bit of a big property and earn
                  returns on appreciation of the property.
                </p>
              </div>
            </div>
          </div>
